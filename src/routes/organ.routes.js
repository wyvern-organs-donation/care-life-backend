...
organRoutes.get("/filter", passport.authenticate('admin', { session: false }),
                // #swagger.tags = ['Organ']
...
organRoutes.get("/", passport.authenticate('admin', { session: false }),
                // #swagger.tags = ['Organ']
...
organRoutes.get("/:id", passport.authenticate('admin', { session: false }),
                // #swagger.tags = ['Organ']
...
organRoutes.post("/", passport.authenticate('admin', { session: false }),
                // #swagger.tags = ['Organ']
...
organRoutes.put("/:id", passport.authenticate('admin', { session: false }),
                // #swagger.tags = ['Organ']
...
organRoutes.delete("/:id", passport.authenticate('admin', { session: false }),
                // #swagger.tags = ['Organ']
